        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-3xl mx-auto">
            <div className="text-center">
              ...
              <div className="text-gray-300">Verified Security Experts</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-blue-400 mb-2">$350M+</div>
              <div className="text-gray-300">Assets Protected</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-purple-400 mb-2">2,500+</div>
              <div className="text-gray-300">Audits Completed</div>
            </div>
          </div>
        </div>
      </div>
