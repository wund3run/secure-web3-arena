        ...
        <div className="py-8 md:py-12">
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
            ...
            <div className="col-span-2 md:col-span-1">
              <h3 className="text-sm font-semibold text-foreground mb-3">Join Hawkly</h3>
              <ul className="space-y-2 text-sm">
                <li>
                  <Link to="/service-provider-onboarding" className="text-muted-foreground hover:text-foreground">
                    Security Providers
                  </Link>
                </li>
                <li>
                  <Link to="/service-provider-onboarding?tab=auditor" className="text-muted-foreground hover:text-foreground">
