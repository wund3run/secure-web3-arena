...
export function AdminPlatformReport() {
  ...
  return (
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        <h2 className="text-xl font-bold">Platform Audit Report</h2>
        <Button 
          variant="outline" 
          size="sm" 
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  <Card>
                    ...
                    <CardContent className="space-y-2">
                      ...
                      <Badge variant="outline" className="mt-2">User Type: Project Owner</Badge>
                    </CardContent>
                  </Card>
                  <Card>
                    <CardHeader className="pb-2">
                    ...
                    <CardContent className="space-y-2">
                      ...
                      <Badge variant="outline" className="mt-2">User Type: Auditor</Badge>
                    </CardContent>
                  </Card>
                </div>
