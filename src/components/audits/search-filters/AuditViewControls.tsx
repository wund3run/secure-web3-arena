  ...
  return (
    <div className="flex flex-wrap gap-2 items-center" role="toolbar" aria-label="View controls">
      <Button 
        ...
        className="hover:bg-muted transition-colors relative focus:ring-2 focus:ring-primary/50 focus:outline-none"
      ...
      <div className="flex border rounded-md" role="group" aria-label="View mode selection">
        <TooltipProvider>
          <Tooltip>
            <TooltipTrigger asChild>
              <Button
                ...
                size="sm"
                className={`px-3 py-1 ${viewMode === "grid" ? "bg-background shadow-sm" : "hover:bg-muted/60"} focus:ring-2 focus:ring-primary/50 focus:outline-none`}
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Button
                ...
                size="sm"
                className={`px-3 py-1 ${viewMode === "list" ? "bg-background shadow-sm" : "hover:bg-muted/60"} focus:ring-2 focus:ring-primary/50 focus:outline-none`}
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <Button 
              variant="outline" 
              size="sm"
              className="hover:bg-muted transition-colors focus:ring-2 focus:ring-primary/50 focus:outline-none"
