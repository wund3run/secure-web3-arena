...
export function ComparisonResponsive({ services, onRemoveService }: ComparisonResponsiveProps) {
  ...
  // Function to focus the comparison heading
  ...
  return (
    <div className="space-y-6 mt-4" ref={containerRef}>
      ...
      <h2 tabIndex={-1} className="text-2xl font-bold focus:outline-none">
        Service Comparison
      ...
      <MarketplaceErrorBoundary>
        {services.length > 0 ? (
          ...
          <div className="text-center py-12 border border-border/30 rounded-lg bg-muted/30">
